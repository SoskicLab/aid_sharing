...
chunk_to_use <- split_sum_stats(aid_sumstats, 10000, 100)
...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/rev_1/03_gwas_estimation/missing_chunks/chunk_100/', paste0('100_',counter, '_gwas_rev1.RDS')))
