...
chunk_to_use <- split_sum_stats(aid_sumstats, 10000, 473 )
...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/rev_1/03_gwas_estimation/missing_chunks/chunk_473/', paste0('473_',counter, '_gwas_rev1.RDS')))
