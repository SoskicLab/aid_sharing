...
chunk_to_use <- split_sum_stats(aid_sumstats, 10000, 353 )
...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/rev_1/03_gwas_estimation/missing_chunks/chunk_353/', paste0('353_',counter, '_gwas_rev1.RDS')))
